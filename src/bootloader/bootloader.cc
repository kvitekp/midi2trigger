...
DigitalInput<LearnSwitchPort> learn_switch;
Led<Led1Port, LED_SOURCE_CURRENT> led1;
Led<Led2Port, LED_SOURCE_CURRENT> led2;
...
inline void Init() {
  cli();
  learn_switch.Init();
  learn_switch.EnablePullUpResistor();
  led1.Init();
  led2.Init();
}
